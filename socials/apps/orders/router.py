...
from socials.apps.users.user import get_current_active_user, get_current_admin_user
from socials.apps.users.models import BaseUser
...
from socials.apps.cart.cart import delete_session_cart

# imprort send order notifications
from socials.apps.notifications.new_order import send_order_admin_notification
