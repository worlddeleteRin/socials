...
from socials.apps.users.user import get_current_user, get_current_user_silent
from socials.apps.users.models import BaseUser
# from coupons app
from socials.apps.coupons.coupon import get_coupon_by_id
from socials.apps.coupons.models import BaseCoupon
